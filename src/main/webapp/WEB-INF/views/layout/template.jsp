...
<title><spring:message code="${titleKey}" text="Legacy Uploader" /></title>
...
<body>
  <div class="container">
    ...
    <p style="text-align: center; background: #e5eCf9;">Copyright
      &copy; 2013 <a href="http://ik.am">IK.AM</a> [<a href="https://github.com/making/legacy-uploader">Fork</a>]</p>
  </div>
</body>
</html>
